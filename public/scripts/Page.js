...
(function( $ ) {
    ...
    $.fn.pages = function( options ) {
        ...
        settings.pages.forEach(function(page){
            ...
            .enter(function () {})
            .exit(function () {
                $(self).removeClass('animated fadeOutRight');
                $(self).removeClass('animated fadeInLeft');
                $(self).addClass('animated fadeOutRight');
            })
            .to(function () {
...
var PageVM = function (pages, dataService) {
    ...
    $("#" + containerID).attr("data-bind", "with: currentVM");
